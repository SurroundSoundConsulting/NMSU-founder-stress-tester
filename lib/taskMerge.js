 ...
 * @param {string[][]} existingDataRows - same shape as master sheet (full width)
...
/**
 * Build one Master Action Board row (base 16 cells; padRow pads to full width including Week 5 columns).
